    ...
    <main class="w-full flex items-center justify-center">
        <div class="flex flex-col items-center text-center gap-6 px-4">
            ...
            <div class="absolute inset-0 -z-10 flex items-center justify-center">
                <div class="w-72 h-72 bg-red-500/10 rounded-full blur-3xl"></div>
            </div>
            ...
            <!-- Heading -->
            <h1 class="text-3xl sm:text-6xl lg:text-7xl tracking-wider">
                Welcome to <span class="text-[#F53003]">Ruangin</span>
            </h1>

            <!-- Subtitle -->
            <p class="text-base sm:text-lg text-[#706f6c] max-w-md">
                Smart room management & booking system built with Laravel.
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3 mt-4">
                ...
                @else
                    <a href="{{ route('login') }}" class="solid-red-btn">
                        Get Started
                    </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="solid-white-btn">
                            Create Account
                        </a>
                    @endif
                @endauth
